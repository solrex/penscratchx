...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-footer">
		<?php
			...
			$categories_list = get_the_category_list( __( ', ', 'penscratch' ) );
			if ( $categories_list && penscratch_categorized_blog() ) :
		?>
		<span class="cat-links">
			<?php printf( __( 'Posted in %1$s', 'penscratch' ), $categories_list ); ?>
		</span>
